 ...
 * @LastEditors: Nxf
 * @LastEditTime: 2022-05-08 22:16:10
 * @Descripttion: 
-->
...
<script>
    ...
    export default {
        ...
        async mounted(){
            ...
            const userData = await this.test_model_method();
        ...
        methods:{
            ...
            async test_model_method () {
                const Model = odooRpc.env.model('res.users');
                //    const Model = odooRpc.env.model('res.company');
                ...
                console.log('---- test_model_method ----',result);
                return result;
            }
        }
    }
